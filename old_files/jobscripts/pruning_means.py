...
folder = "../pruning/pruning_means_ioi"
batch_size = 18
...
while i < 100000:
    ...
    lp.add_entry({"kl_loss": kl_losses.mean().item(), "step_size": step_sz.item()})
